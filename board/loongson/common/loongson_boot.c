...
static char* boot_param_list[LOONGSON_BOOT_TYPE_SIZE] = {"ssd", "nand"};
static loongson_boot_func boot_func_list[LOONGSON_BOOT_TYPE_SIZE] = {loongson_boot_ssd, loongson_boot_nand};
